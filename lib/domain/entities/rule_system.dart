...
class RuleSystem {
  ...
  static const _dnd5e = RuleSystem(
    ...
    description:
        'Clásica fantasía épica con magia, dragones y aventuras legendarias.',
    genre: 'Fantasy',
    ...
    statSchema: {
      ...
      'AC': StatDefinition(
        ...
        min: 1,
        max: 30,
        type: StatType.derived,
      ),
      'LEVEL': StatDefinition(
        label: 'Nivel',
        min: 1,
        max: 20,
        type: StatType.derived,
  ...
  static const _pathfinder2e = RuleSystem(
    ...
    name: 'Pathfinder 2e',
    description:
        'Aventuras tácticas en el mundo de Golarion con un sistema detallado de acciones.',
    genre: 'Fantasy',
    ...
    statSchema: {
      ...
      'HERO_POINTS': StatDefinition(
        label: 'Puntos de Héroe',
        min: 0,
        max: 3,
        type: StatType.resource,
      ),
  ...
  static const _coc7e = RuleSystem(
    ...
    description:
        'Horror cósmico lovecraftiano. Investiga lo desconocido... si te atreves.',
    genre: 'Horror',
    ...
    statSchema: {
      ...
      'MAX_SAN': StatDefinition(
        label: 'Cordura Máxima',
        min: 0,
        max: 99,
        type: StatType.resource,
      ),
      'MP': StatDefinition(
        label: 'Puntos de Magia',
        min: 0,
        max: 20,
        type: StatType.resource,
      ),
