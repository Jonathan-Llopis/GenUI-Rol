...
class ChatBloc extends Bloc<ChatEvent, ChatState> {
  ...
  ChatBloc(
    ...
    on<OnChatGeminiSendMessage>((event, emit) async {
      emit(ChatState.loading(state));
      final List<Map<String, String>> messagesUpdate = List.from(
        state.messagesGemini,
      ...
      try {
        ...
        final List<Map<String, String>> messagesUpdateIA = List.from(
          state.messagesGemini,
